...
import { Target, BarChart3, Shield, AlertCircle, CheckCircle2, Sparkles } from "lucide-react";
...
export default function HomePage() {
  return (
    <>
      ...
      {/* Trust Section */}
      <section className="section-padding bg-gradient-to-br from-teal-light/20 via-white to-teal-accent/10 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-1/4 w-64 h-64 bg-teal-accent rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-teal-light rounded-full blur-3xl"></div>
        </div>
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            <div className="flex items-center justify-center mb-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-teal-accent to-teal-light flex items-center justify-center animate-pulse-slow">
        ...
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-center mb-6">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-red-400 to-orange-400 flex items-center justify-center animate-pulse-slow">
      ...
      {/* Solution Section */}
      <section className="section-padding bg-gradient-to-br from-teal-accent/10 via-white to-teal-light/10 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 right-10 w-72 h-72 bg-teal-accent rounded-full blur-3xl animate-pulse-slow"></div>
        </div>
        <div className="container-custom relative z-10">
          <SectionHeader
            title="Our solution"
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-center mb-6">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-teal-accent to-teal-light flex items-center justify-center animate-pulse-slow">
                <BrainNetworkIcon className="w-10 h-10 text-white" />
              </div>
            </div>
            <div className="space-y-6 text-text-secondary">
            <p className="text-lg">
      ...
      {/* Initial Focus */}
      <section className="section-padding bg-gradient-to-br from-white via-teal-light/10 to-teal-accent/5 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-10 right-1/4 w-64 h-64 bg-teal-light rounded-full blur-3xl"></div>
        </div>
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
      ...
      {/* Feature Highlights */}
      <section className="section-padding bg-gradient-to-br from-teal-light/10 via-white to-teal-accent/10 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute bottom-10 left-1/4 w-80 h-80 bg-teal-accent rounded-full blur-3xl animate-pulse-slow"></div>
        </div>
        <div className="container-custom relative z-10">
          <SectionHeader
            title="Key features"
